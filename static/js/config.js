...
const FFP = [
  ...
  {id:'avios',      name:'Avios',             airline:'Qatar / British Airways / Iberia',code:'QR',    alliance:'Oneworld',       color:'#8A1538',
  ...
  {id:'asiamiles',  name:'Asia Miles',        airline:'Cathay Pacific',                  code:'CX',    alliance:'Oneworld',       color:'#007A33',
